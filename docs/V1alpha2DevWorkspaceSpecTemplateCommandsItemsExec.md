...
**env** | [**List&lt;V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv&gt;**](V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv.md) | Optional list of environment variables that have to be set before running the command |  [optional]
**group** | [**V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecGroup**](V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecGroup.md) |  |  [optional]
