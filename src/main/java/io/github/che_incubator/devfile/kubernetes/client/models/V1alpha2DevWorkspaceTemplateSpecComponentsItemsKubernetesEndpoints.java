...
public class V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints {
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints annotation(Map<String, String> annotation) {
    
    this.annotation = annotation;
    return this;
  }

  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints putAnnotationItem(String key, String annotationItem) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints attributes(Object attributes) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints exposure(ExposureEnum exposure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints path(String path) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints secure(Boolean secure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints targetPort(Integer targetPort) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints = (V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints) o;
    return Objects.equals(this.annotation, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.annotation) &&
        Objects.equals(this.attributes, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.attributes) &&
        Objects.equals(this.exposure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.exposure) &&
        Objects.equals(this.name, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.path) &&
        Objects.equals(this.protocol, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.protocol) &&
        Objects.equals(this.secure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.secure) &&
        Objects.equals(this.targetPort, v1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints.targetPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecComponentsItemsKubernetesEndpoints {\n");
