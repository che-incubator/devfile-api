...
public class V1alpha2DevWorkspaceSpecTemplateCommandsItemsExec {
  ...
  private List<V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv> env = null;
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateCommandsItemsExec env(List<V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv> env) {
  ...
  **/
  ...
  public List<V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv> getEnv() {
    return env;
  }


  public void setEnv(List<V1alpha2DevWorkspaceSpecTemplateCommandsItemsExecEnv> env) {
    this.env = env;
  }
