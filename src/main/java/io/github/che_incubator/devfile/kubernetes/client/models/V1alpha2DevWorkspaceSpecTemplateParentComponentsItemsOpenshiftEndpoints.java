...
public class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints {
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints annotation(Map<String, String> annotation) {
    
    this.annotation = annotation;
    return this;
  }

  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints putAnnotationItem(String key, String annotationItem) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints attributes(Object attributes) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints exposure(ExposureEnum exposure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints path(String path) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints secure(Boolean secure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints targetPort(Integer targetPort) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints = (V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints) o;
    return Objects.equals(this.annotation, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.annotation) &&
        Objects.equals(this.attributes, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.attributes) &&
        Objects.equals(this.exposure, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.exposure) &&
        Objects.equals(this.name, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.path) &&
        Objects.equals(this.protocol, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.protocol) &&
        Objects.equals(this.secure, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.secure) &&
        Objects.equals(this.targetPort, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints.targetPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsOpenshiftEndpoints {\n");
