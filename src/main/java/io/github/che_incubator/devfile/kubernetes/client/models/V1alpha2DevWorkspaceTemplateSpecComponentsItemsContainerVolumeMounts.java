...
public class V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts {
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts path(String path) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts = (V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts) o;
    return Objects.equals(this.name, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerVolumeMounts {\n");
