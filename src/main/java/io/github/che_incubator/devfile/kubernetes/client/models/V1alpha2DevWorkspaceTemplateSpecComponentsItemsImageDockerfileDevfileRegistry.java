...
public class V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry {
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry id(String id) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry registryUrl(String registryUrl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry v1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry = (V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry) o;
    return Objects.equals(this.id, v1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry.id) &&
        Objects.equals(this.registryUrl, v1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry.registryUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecComponentsItemsImageDockerfileDevfileRegistry {\n");
