...
public class V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints {
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints annotation(Map<String, String> annotation) {
    
    this.annotation = annotation;
    return this;
  }

  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints putAnnotationItem(String key, String annotationItem) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints attributes(Object attributes) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints exposure(ExposureEnum exposure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints path(String path) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints secure(Boolean secure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints targetPort(Integer targetPort) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints = (V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints) o;
    return Objects.equals(this.annotation, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.annotation) &&
        Objects.equals(this.attributes, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.attributes) &&
        Objects.equals(this.exposure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.exposure) &&
        Objects.equals(this.name, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.path) &&
        Objects.equals(this.protocol, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.protocol) &&
        Objects.equals(this.secure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.secure) &&
        Objects.equals(this.targetPort, v1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints.targetPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecComponentsItemsContainerEndpoints {\n");
