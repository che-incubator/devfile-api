...
public class V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry {
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry id(String id) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry registryUrl(String registryUrl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry v1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry = (V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry) o;
    return Objects.equals(this.id, v1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry.id) &&
        Objects.equals(this.registryUrl, v1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry.registryUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecParentComponentsItemsImageDockerfileDevfileRegistry {\n");
