...
public class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts {
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts path(String path) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts = (V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts) o;
    return Objects.equals(this.name, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsContainerVolumeMounts {\n");
