...
public class V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints {
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints annotation(Map<String, String> annotation) {
    
    this.annotation = annotation;
    return this;
  }

  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints putAnnotationItem(String key, String annotationItem) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints attributes(Object attributes) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints exposure(ExposureEnum exposure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints name(String name) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints path(String path) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints protocol(ProtocolEnum protocol) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints secure(Boolean secure) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints targetPort(Integer targetPort) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints = (V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints) o;
    return Objects.equals(this.annotation, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.annotation) &&
        Objects.equals(this.attributes, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.attributes) &&
        Objects.equals(this.exposure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.exposure) &&
        Objects.equals(this.name, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.name) &&
        Objects.equals(this.path, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.path) &&
        Objects.equals(this.protocol, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.protocol) &&
        Objects.equals(this.secure, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.secure) &&
        Objects.equals(this.targetPort, v1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints.targetPort);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecComponentsItemsOpenshiftEndpoints {\n");
