...
import io.github.che_incubator.devfile.kubernetes.client.models.V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv;
...
public class V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec {
  ...
  private List<V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv> env = null;

  public static final String SERIALIZED_NAME_GROUP = "group";
  @SerializedName(SERIALIZED_NAME_GROUP)
  private V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecGroup group;
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec commandLine(String commandLine) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec component(String component) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec env(List<V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv> env) {
    
    this.env = env;
    return this;
  }

  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec addEnvItem(V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv envItem) {
    if (this.env == null) {
  ...
  **/
  ...
  public List<V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv> getEnv() {
    return env;
  }


  public void setEnv(List<V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecEnv> env) {
    this.env = env;
  }


  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec group(V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecGroup group) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecGroup getGroup() {
    return group;
  }


  public void setGroup(V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExecGroup group) {
    this.group = group;
  }


  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec hotReloadCapable(Boolean hotReloadCapable) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec label(String label) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec workingDir(String workingDir) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec = (V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec) o;
    return Objects.equals(this.commandLine, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.commandLine) &&
        Objects.equals(this.component, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.component) &&
        Objects.equals(this.env, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.env) &&
        Objects.equals(this.group, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.group) &&
        Objects.equals(this.hotReloadCapable, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.hotReloadCapable) &&
        Objects.equals(this.label, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.label) &&
        Objects.equals(this.workingDir, v1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec.workingDir);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceTemplateSpecParentCommandsItemsExec {\n");
