...
import io.github.che_incubator.devfile.kubernetes.client.models.V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands;
...
import io.github.che_incubator.devfile.kubernetes.client.models.V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginKubernetes;
...
public class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin {
  public static final String SERIALIZED_NAME_COMMANDS = "commands";
  @SerializedName(SERIALIZED_NAME_COMMANDS)
  private List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands> commands = null;

  public static final String SERIALIZED_NAME_COMPONENTS = "components";
  @SerializedName(SERIALIZED_NAME_COMPONENTS)
  private List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginComponents> components = null;
  ...
  private V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginKubernetes kubernetes;
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin commands(List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands> commands) {
    
    this.commands = commands;
    return this;
  }

  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin addCommandsItem(V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands commandsItem) {
  ...
  **/
  ...
  public List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands> getCommands() {
    return commands;
  }


  public void setCommands(List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginCommands> commands) {
    this.commands = commands;
  }


  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin components(List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginComponents> components) {
    
    this.components = components;
    return this;
  }

  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin addComponentsItem(V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginComponents componentsItem) {
  ...
  **/
  ...
  public List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginComponents> getComponents() {
    return components;
  }


  public void setComponents(List<V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginComponents> components) {
    this.components = components;
  }


  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin id(String id) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin kubernetes(V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginKubernetes kubernetes) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginKubernetes getKubernetes() {
    return kubernetes;
  }


  public void setKubernetes(V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPluginKubernetes kubernetes) {
    this.kubernetes = kubernetes;
  }


  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin registryUrl(String registryUrl) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin uri(String uri) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin version(String version) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin = (V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin) o;
    return Objects.equals(this.commands, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.commands) &&
        Objects.equals(this.components, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.components) &&
        Objects.equals(this.id, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.id) &&
        Objects.equals(this.kubernetes, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.kubernetes) &&
        Objects.equals(this.registryUrl, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.registryUrl) &&
        Objects.equals(this.uri, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.uri) &&
        Objects.equals(this.version, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsPlugin {\n");
