...
public class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry {
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry id(String id) {
  ...
  **/
  ...
  public V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry registryUrl(String registryUrl) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry = (V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry) o;
    return Objects.equals(this.id, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry.id) &&
        Objects.equals(this.registryUrl, v1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry.registryUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha2DevWorkspaceSpecTemplateParentComponentsItemsImageDockerfileDevfileRegistry {\n");
